...
An additional workflow executes against the latest Python 3.15 pre-release available on GitHub Actions (currently `3.15.0-alpha.2`) to detect upcoming compatibility issues early.
